    ...
    public class OnlineShopContext : DbContext
    {
        ...
        public void SeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 8, Name = "Löparskor", Description = "Skor för långdistans löpning", Price = 1499, StockQuantity = 18, CategoryId = 4, SupplierId = 4 },
                ...
                //new Product { Id = 15, Name = "", Description = "", Price = , StockQuantity = , CategoryId = , SupplierId = , }
                // | 12 | Tablet | 10" surfplatta med WiFi | 4299 | 9 | 1 | 5 | ??
            ...
            modelBuilder.Entity<Suppliers>().HasData(
                new Suppliers { Id = 1, Name = "TechVision AB", ContactPerson = "Anna Lindberg", Email = "anna@techvision.se", Phone = "070-123-4567" },
                new Suppliers { Id = 2, Name = "HomeStyle", ContactPerson = "Johan Bergman", Email = "johan@homestyle.se", Phone = "073-234-5678" },
                new Suppliers { Id = 3, Name = "Fashion First", ContactPerson = "Maria Ek", Email = "maria@fashionfirst.se", Phone = "076-345-6789" },
                new Suppliers { Id = 4, Name = "SportMax", ContactPerson = "Erik Strand", Email = "erik@sportmax.se", Phone = "072-456-7890" },
                new Suppliers { Id = 5, Name = "Nordic Electronics", ContactPerson = "Karl Holm", Email = "karl@nordicelec.se", Phone = "070-567-8901" },
                new Suppliers { Id = 6, Name = "Global Gadgets", ContactPerson = "Lisa Björk", Email = "lisa@globalgadgets.se", Phone = "073-678-9012" }
            );

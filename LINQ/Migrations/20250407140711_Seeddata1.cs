        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, 4, "Skor för långdistans löpning", "Löparskor", 1499m, 18, 4 },
                    { 9, 4, "Halkfri yogamata", "Yogamata", 349m, 30, 4 },
                    { 10, 5, "Populär skönlitteratur roman", "Bestsellerroman", 249m, 40, 2 },
                    { 11, 1, "Högprestanda dator för gaming", "Gaming PC", 18999m, 5, 6 },
                    { 12, 1, " 10 tum Surfplatta med Wifi", "Tablet", 4299m, 9, 2 },
                    { 13, 1, "Portabel högtalare med 20h batteritid", "Bluetooth-hötalare", 899m, 22, 6 },
